...
{
    BOOL hiddenNavBar = [viewController isKindOfClass:[NSClassFromString(@"DRHomePageViewController") class]] || [viewController isKindOfClass:[NSClassFromString(@"DRHomePageHtmlViewController") class]] || [viewController isKindOfClass:[NSClassFromString(@"DRGoodDetailViewController") class]] || [viewController isKindOfClass:[NSClassFromString(@"DRShopDetailViewController") class]] || [viewController isKindOfClass:[NSClassFromString(@"DRUserShowViewController") class]] || [viewController isKindOfClass:[NSClassFromString(@"DRMineViewController") class]] || [viewController isKindOfClass:[NSClassFromString(@"DRMyShopViewController") class]];
