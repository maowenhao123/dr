...
- (void)setupChildViews
{
    ...
    remainLabel.text = @"已团数量";
    remainLabel.textColor = DRBlackTextColor;
    remainLabel.font = [UIFont systemFontOfSize:DRGetFontSize(24)];
    ...
    remainNumberLabel.textColor = DRBlackTextColor;
...
{
    //plusCount
    if ([self.numberView.currentNum intValue] > (self.plusCount + [self.goodModel.plusCount intValue])) {
